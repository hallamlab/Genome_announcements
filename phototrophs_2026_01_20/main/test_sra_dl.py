...
input_raw = [
    ("SRR36906171", "ncbi::sra_accession", dict(parity="single", length_class="long")),
    ("SRR36906170", "ncbi::sra_accession", dict(parity="single", length_class="long")),
    ("SRR36921393", "ncbi::sra_accession", dict(parity="single", length_class="long")),
    ("SRR36921392", "ncbi::sra_accession", dict(parity="single", length_class="long")),
